<%@ Page Title="" Language="C#" MasterPageFile="Prothsahanteam.master" AutoEventWireup="true" CodeFile="VolunteerRegistration.aspx.cs" Inherits="demo_VolunteerRegistration" %>
    ...
    <script>
         function Validate() {
            ...
            if ($('#<%=txtMobile.ClientID %>').val() == "") {
                validateError('<%=txtMobile.ClientID %>', "Please Enter mobile no !");
                 return false;
             }
             else {
                 validateSuccess('<%=txtMobile.ClientID %>');
             }
        }
    </script>
      <div id="main">
                                                ...
                                                <div style="display: block;" class="onetimeforminput">
                                                    ...
                                                    <h4 class="h4-branch"><strong>Personal Detail</strong></h4>
                                                            ...
                                                            <div class="col-lg-5 col-md-5 col-sm-6 col-xs-6">
                                                                <div class="form-group">
                                                                    ...
                                                                    <asp:TextBox ID="txtFirstName" runat="server" class="form-control" required></asp:TextBox>
                                                                </div>
                                                            </div>
                                                            <div class="col-lg-5 col-md-5 col-sm-6 col-xs-6">
                                                                <div class="form-group">
                                                            ...
                                                            <div class="col-lg-6 col-md-6 col-sm-6 col-xs-6">
                                                                <div class="form-group">
                                                                    <label for="email">Email*</label><br>
                                                                      <asp:TextBox ID="txtEmail" runat="server" class="form-control" onblur="CheckEmailFormate(this);"></asp:TextBox>
                                                                </div>
                                                            </div>
                                                            <div class="col-lg-6 col-md-6 col-sm-6 col-xs-6">
                                                                <div class="form-group">
                                                                    <label for="mobile">Mobile*</label><br>
                                                                    <asp:TextBox ID="txtMobile" runat="server" class="form-control" onkeypress="return OnlyNumber(event);"></asp:TextBox>
                                                                </div>
                                                            </div>
                                                        </div>
                                                    </div>
                                                            ...
                                                            <div class="col-lg-6 col-mnd-6 col-sm-6 col-xs-12">
                                                                ...
                                                                <div class="row">
                                                                    <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                                                                        ...
                                                                        <div class="form-group block indianState" id="drpState" runat="server" >
                                                    ...
                                                    <div class="col-lg-6 col-md-6 col-sm-6 col-xs-6">
                                                        <div class="form-group">
                                                            ...
                                                            <asp:TextBox ID="txtPin" runat="server" class="form-control" onkeypress="return OnlyNumber(event);"></asp:TextBox>
                                                        </div>
                                                    </div>
                                                    ...
                                                    <div class="col-lg-6 col-md-6 col-sm-6 col-xs-6">
                                                        <div class="form-group">
                                                            ...
                                                            <asp:TextBox ID="txtAdditional" runat="server" class="form-control" TextMode="MultiLine"></asp:TextBox>
                                                        </div>
                                                    </div>
                                                    <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                                                         <div class="row">
                                                        ...
                                                        <div class="col-sm-6 col-xs-12">
                                                          <div class="form-group">
                                                            <label for="pin">Name</label><br>
                                                              <asp:TextBox ID="txtRefName1" runat="server" class="form-control"></asp:TextBox>
                                                             <label for="pin">Occupation</label><br>
                                                             <asp:TextBox ID="txtRefOccupation1" runat="server" class="form-control"></asp:TextBox>
                                                                    <label for="pin">Address</label><br>
                                                           <asp:TextBox ID="txtRefAddress1" runat="server" class="form-control"></asp:TextBox>
                                                                    <label for="pin">Contact No.</label><br>
                                                           <asp:TextBox ID="txtRefContact1" runat="server" class="form-control"></asp:TextBox>
                                                                   <label for="pin">Email</label><br>
                                                            <asp:TextBox ID="txtRefEmail1" runat="server" class="form-control" onblur="CheckEmailFormate(this);"></asp:TextBox>
                                                        </div>
                                                        </div>
                                                             <div class="col-sm-6 col-xs-12">
                                                              <div class="form-group">
                                                            <div class="form-group">
                                                            <label for="pin">Name</label><br>
                                                             <asp:TextBox ID="txtRefName2" runat="server" class="form-control"></asp:TextBox>
                                                             <label for="pin">Occupation</label><br>
                                                         <asp:TextBox ID="txtRefOccupation2" runat="server" class="form-control"></asp:TextBox>
                                                                    <label for="pin">Address</label><br>
                                                            <asp:TextBox ID="txtRefAddress2" runat="server" class="form-control"></asp:TextBox>
                                                                    <label for="pin">Contact No.</label><br>
                                                            <asp:TextBox ID="txtRefContact2" runat="server" class="form-control"></asp:TextBox>
                                                                   <label for="pin">Email</label><br>
                                                         <asp:TextBox ID="txtRefEmail2" runat="server" class="form-control" onblur="CheckEmailFormate(this);"></asp:TextBox>
                                                        </div>
                                                        </div>
                                                        </div>
                                                    </div>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-lg-6 col-lg-offset-3 col-md-offset-3 col-md-6 col-sm-6 col-xs-12">
                                        <div class="buttonsregister btn-volunteer">
                                           <asp:Button ID="btnSubmit" runat="server" Text="Submit" CssClass="form-control btn btn-volunteer" Style="font-family: 'latoblack',sans-serif !important;" OnClick="btnSubmit_Click" OnClientClick="return Validate();" />
                                        </div>
                                    </div>
                                </div>
                                <style>
